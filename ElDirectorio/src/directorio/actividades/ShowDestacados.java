...
public class ShowDestacados extends MenuActivity {
	...
	public void addButtons() {
		// TODO Auto-generated method stub
		super.addButtons();
		Button b = (Button) findViewById(R.id.destacados);
		b.setBackgroundResource(R.drawable.destacados_pressed);
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Lista.setAdapter(new DestacadosAdapter(this, adds));
				...
				Thread holo = new Thread() {
					public void run() {
						...
						try {
							sleep(100);
							Class texto = Class
									.forName("directorio.actividades.ShowAdvertiserActivity");
							Intent correo = new Intent(ShowDestacados.this,
									texto);
